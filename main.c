 ...
 typedef struct{
  ...
  Tindix=0;
      ...
      void  AjouterPLproduits(){      // ajouter plusieur produit
        ...
        void TRIPARPRIX(){      // lister tous les produits selon l�ordre  d�croissant du prix.
      ...
      void TRIPARAPLPHA(){   //Lister tous les produits selon l�ordre alphab�tique  croissant du nom.
   ...
   void SupprimerProduits(){   //Supprimer les produits par CODE
    ...
    void  EtatStock(){  //afficher les produits dont la quantit� est inf�rieure � 3.
        int i;
        int q=0;
        for(i=0;i<Tindix;i++){
